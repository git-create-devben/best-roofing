        ...
        <footer className="bg-black text-white pt-20 pb-10 border-t border-white/10">
            <div className="container mx-auto px-6">
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-gray-400 text-sm leading-relaxed">
                            Lagos&apos;s premier roofing contractor. We deliver excellence, durability, and style to every project we touch.
                            Licensed and insured for your peace of mind.
                        </p>
                        <div className="flex gap-4">
                            <a href="#" className="w-10 h-10 rounded-full bg-[var(--color-charcoal-light)] flex items-center justify-center hover:bg-[var(--color-primary-gold)] hover:text-black transition-colors"><Facebook size={18} /></a>
                            <a href="#" className="w-10 h-10 rounded-full bg-[var(--color-charcoal-light)] flex items-center justify-center hover:bg-[var(--color-primary-gold)] hover:text-black transition-colors"><Instagram size={18} /></a>
                            <a href="#" className="w-10 h-10 rounded-full bg-[var(--color-charcoal-light)] flex items-center justify-center hover:bg-[var(--color-primary-gold)] hover:text-black transition-colors"><Linkedin size={18} /></a>
                        </div>
                    </div>
                ...
                <div className="border-t border-white/10 pt-8 text-center text-xs text-gray-600">
                    <p>&copy; {new Date().getFullYear()} Best Roofing Services. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
